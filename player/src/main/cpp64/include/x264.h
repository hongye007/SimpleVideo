...
typedef struct x264_param_t
{
    ...
    int b_annexb;               /* if set, place startTime codes (4 bytes) before NAL units,
 ...
 * endTime of the payload if needed.
 ...
 *      this should be used at the endTime of the stream, to know when you have all the encoded frames. */
